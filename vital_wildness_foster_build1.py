...
def block(attacker):
    ...
    if reaction <= 1:
        ...
        return (0.8, "You nearly get away with it.")
    elif reaction <= 3.5:
        return (0.5, "You were not paying full attention.")
    else:
...
special_verb = ["block", "leave", "restart"]
...
verb_defi = {
    ...
    "get" : "[info] Get all the characters that are currently in the game",
...
def main():
    ...
    while len(nickname) >= 12 or not nickname or ' ' in nickname:
        print("Your nickname can not contain space",end='')
        print(" and should be no more than 12 characters.")
        print("What is your name, great explorer?")
        nickname = input("💬  ")
