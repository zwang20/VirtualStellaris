if True:
    ...
    Description:\n\
    This system is the default start system\n\
    ...
    Description:\n\
    This system is the default start system for the enemy\n\
    ...
    EnemyFleet3 = []
    EnemyFleet4 = []
    PlayerFleet1Position = 'A'
    PlayerFleet2Position = 'A'
    PlayerFleet3Position = 'A'
    PlayerFleet4Position = 'A'
    EnemyFleet1Position = 'G'
    EnemyFleet2Position = 'G'
    EnemyFleet3Position = 'G'
    EnemyFleet4Position = 'G'
    ProductionPoints = 5
    UpkeepPoints = 5
while True:
    ActionPoints = 15
...
Doing so will remove all the fleets in existence\n\
(Y/N): ')
                if ClearFleets == 'Y':
                    PlayerFleet1 = []
                    PlayerFleet2 = []
